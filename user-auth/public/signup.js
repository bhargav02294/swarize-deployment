document.getElementById("signup-form").addEventListener("submit", async (event) => {
    ...
    try {
        ...
        const response = await fetch("https://swarize.in/auth/signup", { // ✅ Correct API path
            method: "POST",
        ...
        if (response.ok && data.success) {
            ...
            window.location.href = "https://swarize.in/otp"; // ✅ Redirect to OTP verification page
        } else {
...
fetch("https://ipapi.co/json") // ✅ Updated to fetch actual user country
