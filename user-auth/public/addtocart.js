document.addEventListener("DOMContentLoaded", async () => {
    ...
    try {
        // Fetch Cart Items
        const cartResponse = await fetch("http://localhost:3000/cart", { credentials: "include" });
        ...
        cartData.cart.forEach(product => {
            ...
            productDiv.innerHTML = `
                <img src="http://localhost:3000/${product.thumbnailImage}" alt="${product.name}" class="cart-product-thumbnail">
