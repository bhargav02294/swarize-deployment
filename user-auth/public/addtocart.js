document.addEventListener("DOMContentLoaded", async () => {
    ...
    try {
        // Fetch Cart Items
        const cartResponse = await fetch("http://www.swarize.in/cart", { credentials: "include" });
        ...
        cartData.cart.forEach(product => {
            ...
            productDiv.innerHTML = `
                <img src="http://www.swarize.in/${product.thumbnailImage}" alt="${product.name}" class="cart-product-thumbnail">
